...
public class Spare_PartsTypeRestController {
    ...
    @PostMapping("/add")
    public Spare_Parts_types saveSpare_PartsTypes(@RequestBody Spare_Parts_types s) throws InternalServerErrorException
    {
    ...
    public List<Spare_Parts_types> getAllSparePartsTypes() throws InternalServerErrorException
    {
        List<Spare_Parts_types> list = spare_parts_typesService.getAllSparePartsTypes();
        return list;
    }
    @DeleteMapping("/delete")
    public void delete(Spare_Parts_types spare_parts_types) throws InternalServerErrorException
    {
        spare_parts_typesService.deleteSparePartsTypes(spare_parts_types);
    }
    @DeleteMapping("/delete/{st_id}")
    public void deleteById(@PathVariable("st_id") Integer st_id) throws InternalServerErrorException
    {
    ...
    public Spare_Parts_types getSparePartsTypeById(@PathVariable("st_id") Integer st_id) throws InternalServerErrorException
    {
        return  spare_parts_typesService.getSparePartsTypes(st_id);
    }
    @PutMapping("/edit")
    public Spare_Parts_types editSpareParts(@RequestBody Spare_Parts_types s) throws InternalServerErrorException
    {
...
@RequestMapping(value = "/get/{Spare_parts_name}", method = RequestMethod.GET, headers = "Accept=application/json")
    public List<Spare_Parts_types> getUserBySpareParts(@PathVariable String Spare_Parts_types_name)
    {
        return spare_parts_typesService.getSparePartsByTypeName(Spare_Parts_types_name);
    }
